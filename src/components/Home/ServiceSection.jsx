...
const services = [
  {
    // Color Reference: text-[#B62025] dark:text-[#FF4B4B]
    title: "THE DEEP CLEAN",
    desc: "A thorough interior and exterior overhaul using safe decontamination and steam extraction to restore your vehicle to showroom standards.",
    image: "/services/deep-clean.avif",
    path: "/services/the-deep-clean",
  },
  {
    // Color Reference: text-[#B62025] dark:text-[#FF4B4B]
    title: "PAINTWORK ENHANCEMENT",
    desc: "Unlocking deep, reflective gloss with a light machine polish and high-grade 6-month sealant to protect your finish.",
    image: "/services/paint-enhancement.avif",
    path: "/services/paintwork-enhancement",
  },
  {
    // Color Reference: text-[#B62025] dark:text-[#FF4B4B]
    title: "STAGE 1 PAINT CORRECTION",
    desc: "Professional machine correction removing up to 90% of swirls and scratches to restore clarity and preserve vehicle value.",
    image: "/services/paint-correction.avif",
    path: "/services/stage-1-correction",
  },
];
              ...
              >
                ...
                <div className="max-w-sm mx-auto ">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-30  bg-white "
                    onError={(e) => {
